...
假设我们知道了一个observation序列，那么我们如何找到最能与之匹配的状态序列呢，也就是说如何找到序列路径Q，使$$ P(q_1,1_2,...,q_T \vert X,\lambda) $$取最大值，这是实际应用时最常见的问题。我们可以将其定义为如下最大后验概率问题
...
为了解决这个问题，我们需要引入一个新的算法：Viterbi算法，这是一个保持最可能状态序列的动态归纳算法。