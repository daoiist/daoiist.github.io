...
由于其计算过程与forward算法类似，所以计算复杂度也为$$ O(N^2)T $$。
...
L.R.Rabiner. A tutorial on Markov models and selected applications in speech recognition, Proc. IEEE, vol. 77, pp. 257--285, Feb. 1989.

Duda, Hart and Stork, Pattern Classification, 2nd Ed., Wiley 2001.

G.A. Fink. Markov Models for Pattern Recognition, Springer, 2008.

[理解隐马尔可夫模型](http://tensorinfinity.com/paper_99.html)