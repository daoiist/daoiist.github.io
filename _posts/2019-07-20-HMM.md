...
=(1-a_{ii})\sum_{d=1}^{\infty}d \times a_{ii}^{d-1}=(1-a_{ii})\frac{\Game}{\Game a_{ii}}\sum_{d=1}^{\infty} a_{ii}^{d}\\
=(1-a_{ii})\frac{\Game}{\Game a_{ii}}\frac{a_{ii}}{1-a_{ii}}=\frac{1}{1-a_{ii}} $$
